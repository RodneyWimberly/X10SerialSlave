...
/// X10 PowerLine Interface (PSC04/PSC05/TW523).                      
///     - RJ11 pin 1 (YEL) (WHT) -> Zero crossing trigger (Pin: 2)
///     - RJ11 pin 2 (GRN) (BLU) -> Ground (Pin: GND)
///     - RJ11 pin 3 (RED) (RED) -> X10 Transmit (Raspberry Pi Receive X10 command to PLI) (Pin: 3) 
///     - RJ11 pin 4 (BLK) (BLK) -> X10 Receive (Raspberry Pi Transmit X10 command to PLI) (Pin: 4) 
