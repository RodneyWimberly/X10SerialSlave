...
void loop(){
  if (SX10.received()) {                         // received a new command
   ...
   if (SX10.unitCode() == 3){
      ...
      SX10.write(HOUSE_A,UNIT_1,RPT_SEND); 
      SX10.write(HOUSE_A,UNIT_2,RPT_SEND);                
      if(cmndCode == ON) SX10.write(HOUSE_A,ON,RPT_SEND);  
      if(cmndCode == OFF) SX10.write(HOUSE_A,OFF,RPT_SEND); 
    }
  }
} 
